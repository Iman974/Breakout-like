...
public class PowerUpSpawner : MonoBehaviour {
    ...
    private Vector2[] spawnedPowerupsPos;
    ...
    private void Awake() {
        ...
        #endregion
        spawnedPowerupsPos = new Vector2[powerUpSpawnRate];
    }
    ...
    private void SpawnPowerUp() {
        for (int i = 0; i < powerUpSpawnRate; i++) {
            ...
            while (/*Mathf.Abs(spawnedPowerupsLocations[i - 1].x - randomSpawnLocation.x) < deadZoneRadius ||*/
                CheckIfOnBallPath(randomSpawnLocation) || (i > 0 ? CheckDeadZone() : false)) {
            ...
            spawnedPowerupsPos[i] = randomSpawnLocation;
    ...
    private bool CheckDeadZone() {
        for (int i = 0; i < spawnedPowerupsPos.Length; i++) {
